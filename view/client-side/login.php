                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" 
                       ...
                       data-toggle="dropdown" aria-expanded="false">
                        Acerca De <i class="fa fa-info-circle" aria-hidden="true"></i>
                    </a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="contact.php">Contacto  <i class="fa fa-address-book" aria-hidden="true"></i></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../../index.php">Inicio <i class="fa fa-home" aria-hidden="true"></i> </a>
                    </li>
                    <?php 
                            session_start();
                            if (!isset($_SESSION['id'])){
                                echo '
                                    <li class="nav-item">
                                        <a class="nav-link" href="login.php" class="" style="width: 100%">Iniciar Sesion <img
